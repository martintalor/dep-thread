...
@Service
@Scope("prototype")
public class FileEncryptOnlyMainSection   extends BaseSectionThreadPool implements Section, Status {
    ...
    public FileEncryptOnlyMainSection() {
        synchronized (logger){
            if(fixedUpStreamThreadPool == null){
                fixedUpStreamThreadPool =  Executors.newFixedThreadPool(this.threadNumber,
